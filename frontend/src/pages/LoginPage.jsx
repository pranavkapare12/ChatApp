...
import { Mail, MessageSquare, User, Lock, EyeOff, Eye, Loader2, LogIn } from "lucide-react"
...
const Login = () => {
    ...
    return (
        <div className="min-h-screen grid lg:grid-cols-2">
            ...
            <div className="flex flex-col justify-center items-center p-6 sm:p-12">
                <div className="w-full max-w-md space-y-8">
                    ...
                    <div className="text-center">
                        <p className="text-base-content/50">Create Account ...</p>
                        <Link to="/signup" className="link link-primary size-2"> Signup </Link>
                    </div>
                </div>
            </div>
            ...
            <AuthImagePattern title="Hello" subTitle={"Hello from the Login"}/>
        </div>
    )
}
