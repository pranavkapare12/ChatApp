            ...
            <div className="overflow-y-auto w-full py-3">
                {
                    filteredUsers.map((user) => (
                        ...
                        <button key={user._id} onClick={() => setSelectedUser(user)} className={`w-full flex items-center gap-3 hover:bg-base-300 transition-colors ${selectedUser?._id === user._id ? "bg-base-300 ring-1 ring-base-300" : ""}`}>
                            <div className="relative mx-auto lg:mx-0">
                                <img src={user.profilePic || "/react.svg"} alt="" className="size-12 object-cover rounded-full border-2 text-center" />
                                {
