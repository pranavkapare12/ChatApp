  ...
  return (
    <div className="p-4 w-full">
      {imagePreview && (
        <div className="mb-3 flex items-center gap-2">
          <div className="relative">
            <img src={imagePreview} alt="Preview" className="w-20 object-cover rounded-lg border border-zinc-700" />
            { isLoad && (
              <label className='label text-sm pl-1'>Uploading...</label>
            )}
      ...
      <form onSubmit={handleSendMessage} className='flex items-center gap-2'>
        ...
        <button type="submit" className='btn btn-circle '><Send size={20} /></button>
      </form>
    </div>
  )
}
